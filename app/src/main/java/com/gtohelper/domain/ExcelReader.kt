...
fun main() {
    ...
    for (e in ExcelReader().getCompetitorList(0, stream)) {
        println(e)
    }
}
...
class ExcelReader {
    ...
    fun getCompetitorList(competitionId: Int, stream: InputStream): List<Competitor> {
        ...
        for (row in rowId + 1..sheet.lastRowNum) {
            ...
            try {
                ...
                val competitor =
                    Competitor(0, participantNumber, competitionId, name, gender, nameTeam, degree)
