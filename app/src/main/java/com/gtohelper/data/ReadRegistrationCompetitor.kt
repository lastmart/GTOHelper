...
fun main() {
    ...
    val listSport = mutableListOf(
        "Плавание 50 м (мин, с)", "Бег на 60 м (с)",
    ...
    readRegistrationCompetitor.addNormativeAndPoint(
        filePath, JsonParser().convertTime("00:28.01"),
        listCompetitor[0], listSport[0], listColumnStartSport[0]
    )
    readRegistrationCompetitor.addNormativeAndPoint(
        filePath, JsonParser().convertTime("00:29.10"),
        listCompetitor[1], listSport[0], listColumnStartSport[0]
    )
    readRegistrationCompetitor.addNormativeAndPoint(
        filePath, JsonParser().convertTime("00:30.10"),
        listCompetitor[2], listSport[0], listColumnStartSport[0]
    )
    readRegistrationCompetitor.addNormativeAndPoint(
        filePath, JsonParser().convertTime("00:31.10"),
        listCompetitor[3], listSport[0], listColumnStartSport[0]
    )
    readRegistrationCompetitor.addNormativeAndPoint(
        filePath, JsonParser().convertTime("00:34.10"),
    ...
    readRegistrationCompetitor.addNormativeAndPoint(
        filePath, 22.0, listCompetitor[0], listSport[2],
        listColumnStartSport[2]
    )
    readRegistrationCompetitor.addNormativeAndPoint(
        filePath, 20.0, listCompetitor[1], listSport[2],
        listColumnStartSport[2]
    )
    readRegistrationCompetitor.addNormativeAndPoint(
        filePath, 25.0, listCompetitor[2], listSport[2],
        listColumnStartSport[2]
    )
    readRegistrationCompetitor.addNormativeAndPoint(
        filePath, 17.0, listCompetitor[3], listSport[2],
        listColumnStartSport[2]
    )
    readRegistrationCompetitor.addNormativeAndPoint(
        filePath, 15.0, listCompetitor[4], listSport[2],
        listColumnStartSport[2]
    )
    readRegistrationCompetitor.addNormativeAndPoint(
        filePath, 17.0, listCompetitor[5], listSport[2],
        listColumnStartSport[2]
    )

    readRegistrationCompetitor.addCompetitionResults(
        filePath, 12, listColumnStartSport,
        6
    )
...
class ReadRegistrationCompetitor {
    ...
    fun addCompetitionResults(
        filePath: String, columnResult: Int, listColumnStartSport: List<Int>,
    ...
    fun addNormativeAndPoint(
        filePath: String,
        res: Any,
        competitor: Competitor,
        sport: String,
        sportColumnStart: Int
    ) {
        val fileInputStream = FileInputStream(filePath)
        val workBook = XSSFWorkbook(fileInputStream)
        val sheet = workBook.getSheetAt(0)
