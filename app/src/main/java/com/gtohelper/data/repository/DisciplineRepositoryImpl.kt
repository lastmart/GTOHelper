...
class DisciplineRepositoryImpl(
    ...
    private fun initDisciplines(): MutableList<Discipline> {
        ...
        list.add(
            Discipline(
                getDrawable(R.drawable.discipline_long_distance_running),
                "Бег на длинные дистанции"
            )
        )
        list.add(
            Discipline(
                getDrawable(R.drawable.discipline_sprinting),
                "Бег на короткие дистанции"
            )
        )
        list.add(
            Discipline(
                getDrawable(R.drawable.discipline_cross_country),
                "Кросс по пересечённой местности"
            )
        )
        list.add(
            Discipline(
                getDrawable(R.drawable.discipline_mixed_movement),
        ...
        list.add(
            Discipline(
                getDrawable(R.drawable.discipline_nordic_walking),
        ...
        list.add(
            Discipline(
                getDrawable(R.drawable.discipline_movement_on_skis),
                "Передвижение на лыжах"
            )
        )
        list.add(
            Discipline(
                getDrawable(R.drawable.discipline_human_pull_up_top),
                "Подтягивание из виса на высокой перекладине"
            )
        )
        list.add(
            Discipline(
                getDrawable(R.drawable.discipline_human_pull_up_bottom),
                "Подтягивание из виса лежа на низкой перекладине"
            )
        )
        list.add(
            Discipline(
                getDrawable(R.drawable.discipline_flexion_extension_arms),
        ...
        list.add(
            Discipline(
                getDrawable(R.drawable.discipline_standing_long_jump),
                "Прыжок в длину с места"
            )
        )
        list.add(
            Discipline(
                getDrawable(R.drawable.discipline_running_long_jump),
        ...
        list.add(
            Discipline(
                getDrawable(R.drawable.discipline_ball_throwing_at_target),
                "Метание мяча в цель"
            )
        )
